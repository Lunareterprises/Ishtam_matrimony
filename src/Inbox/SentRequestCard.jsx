...
function SentRequestCard({ item }) {
    ...
    console.log("item data in sent request card::", item);
    ...
    return (
        <div>
            <div className="hidden md:flex bg-white shadow-lg rounded-lg overflow-hidden w-full mb-4">
                ...
                {/* Middle - Details */}
                <div className="p-5 flex flex-col justify-between items-start gap-2 w-80">
                    <div>
            ...
            < div className="flex flex-col md:hidden bg-white shadow-lg rounded-lg overflow-hidden w-65 max-w-sm mb-4" >
                ...
                <div className="p-4">
                    ...
                    <p className="text-[13px] text-gray-600">
                        {item.language || "Malayalam"} | {item.u_religion || "Hindu, Nair"} | {item.location || "Alappuzha, Kerala"}
                    </p>

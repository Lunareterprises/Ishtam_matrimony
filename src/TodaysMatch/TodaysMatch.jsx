                    ...
                    <div className='flex flex-col w-full sm:px-0 px-2  py-10 sm:py-30 '>
                            ...
                            <div className='max-w-[750px] w-full px-10 ' >
                                <div className="flex flex-col sm:flex-row bg-white rounded-xl shadow-[0_0_18px_rgba(0,0,0,0.08)] overflow-hidden max-w-3xl w-full mx-auto gap-8">
                                    ...
                                    <div className="flex flex-col justify-center gap-2 p-5 sm:w-2/3 text-center sm:text-left">
                                        ...
                                        {/* CTA Button */}
                                        <button className="mt-3 bg-[#E33183] hover:bg-[#c91e6b] text-white px-6 py-2 rounded-full text-sm font-semibold self-center sm:self-start">
                                            Send Interest
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className='flex flex-col gap-3 px-10 pt-8 items-start' >
                            ...
                            <div class="flex flex-wrap gap-5">
                                <span class="px-5 py-2 flex items-center text-sm font-medium text-[#E33183] border border-[#E33183] rounded-full bg-pink-50">
                                    Playing Musical Instruments
                                </span>
                                <span class="px-5 py-2 flex items-center justify-center text-sm font-medium text-[#E33183] border border-[#E33183] rounded-full bg-pink-50">
                                    Singing
                                </span>
                                <span class="px-5 py-2 flex items-center text-sm font-medium text-[#E33183] border border-[#E33183] rounded-full bg-pink-50">
                                    Writing / Poetry

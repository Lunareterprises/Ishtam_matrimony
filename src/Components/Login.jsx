...
function Login({ onClose, onOtpLogin }) {
          ...
          <form className="flex flex-col sm:gap-6 gap-4">
            ...
            <div className='flex flex-col items-center justify-center gap-3' >
              <div className='w-full'>
                <label className="block text-sm font-medium mb-1 text-[#490B22]">Password</label>
                <input
                  type="password"
              ...
              <div className="flex items-center justify-between text-sm sm:gap-15 gap-3">
                ...
                <button type="button" className="text-[#490B22] hover:underline">
                  Forgot Password?
                </button>
              </div>
            ...
            <div className='flex flex-col gap-3' >
              ...
              <div className='flex flex-col items-center gap-2' >
                <button onClick={onOtpLogin}
                  type="button"
                  className="w-full border border-[#E33183] text-[#E33183] py-2 rounded-lg font-semibold hover:bg-pink-50"
                >
                  Login with OTP
                </button>
                <h1 className='text-[13px] text-[#490B22] ' >Don’t have an account ? <span className='font-medium' >Create account</span></h1>
              </div>
            </div>
